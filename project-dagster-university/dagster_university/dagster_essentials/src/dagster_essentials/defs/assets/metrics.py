...
def manhattan_map() -> None:
    ...
    trips_by_zone.plot(column="num_trips", cmap="plasma", ax=ax, edgecolor='black', legend=True)
...
def trips_by_week(context: dg.AssetExecutionContext, database: DuckDBResource) -> None:
    ...
    query = f"""
        select VendorID as vendor_id, total_amount, trip_distance, passenger_count
        from trips
